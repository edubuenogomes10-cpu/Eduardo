...
export function Tools() {
  return (
    <section id="ferramentas" className="py-20 bg-card">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            As tecnologias que utilizo no meu dia a dia para criar aplicações web
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
          {tools.map((tool) => (
            <div
              key={tool.name}
              className="group flex flex-col items-center p-6 bg-background rounded-xl border border-border hover:border-primary/50 hover:shadow-lg transition-all duration-300"
            >
              <div
                className={`p-4 rounded-xl ${tool.color} group-hover:scale-110 transition-transform duration-300`}
              >
                {tool.icon}
              </div>
              <span className="mt-4 font-medium text-foreground">{tool.name}</span>
            </div>
          ))}
        </div>
      </div>
